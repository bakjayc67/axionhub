...
task.spawn(function()
	...
	if HOOK_DETECTED then
		return warn('[ AxionHub ] http_request hook detected ! Disabled all http requests')
	end
...
if not Config.UI then
	...
	discordText.Text = "Credit: Jayz | AxionHub"
...
if PLACE_ID.sea2() and zQuestProRemote then
	local zQuestProConnection = zQuestProRemote.OnClientEvent:Connect(function(a)
		if a == "promptDialogue" then
			warn("AxionHub : Finished cutscene")
			hopLowServer()
		end
	end)
